...
people_lookup = {
#row 1
    0x17 : (uinput.KEY_LEFTCTRL, uinput.KEY_1),
    0x16 : (uinput.KEY_LEFTCTRL, uinput.KEY_2),
    0x15 : (uinput.KEY_LEFTCTRL, uinput.KEY_3),
    0x14 : (uinput.KEY_LEFTCTRL, uinput.KEY_4),
    0x13 : (uinput.KEY_LEFTCTRL, uinput.KEY_5),
    0x12 : (uinput.KEY_LEFTCTRL, uinput.KEY_6),
    0x11 : (uinput.KEY_LEFTCTRL, uinput.KEY_7),
    0x67 : (uinput.KEY_LEFTCTRL, uinput.KEY_8),
    0x66 : (uinput.KEY_LEFTCTRL, uinput.KEY_9),
    0x65 : (uinput.KEY_LEFTCTRL, uinput.KEY_0),
#row 2
    0x27 : (uinput.KEY_LEFTCTRL, uinput.KEY_Q),
    0x26 : (uinput.KEY_LEFTCTRL, uinput.KEY_W),
    0x25 : (uinput.KEY_LEFTCTRL, uinput.KEY_E),
    0x24 : (uinput.KEY_LEFTCTRL, uinput.KEY_R),
    0x23 : (uinput.KEY_LEFTCTRL, uinput.KEY_T),
    0x22 : (uinput.KEY_LEFTCTRL, uinput.KEY_Y),
    0x21 : (uinput.KEY_LEFTCTRL, uinput.KEY_U),
    0x76 : (uinput.KEY_LEFTCTRL, uinput.KEY_I),
    0x75 : (uinput.KEY_LEFTCTRL, uinput.KEY_O),
    0x64 : (uinput.KEY_LEFTCTRL, uinput.KEY_P),
#row 3
    0x37 : (uinput.KEY_LEFTCTRL, uinput.KEY_A),
    0x36 : (uinput.KEY_LEFTCTRL, uinput.KEY_S),
    0x35 : (uinput.KEY_LEFTCTRL, uinput.KEY_D),
    0x34 : (uinput.KEY_LEFTCTRL, uinput.KEY_F),
    0x33 : (uinput.KEY_LEFTCTRL, uinput.KEY_G),
    0x32 : (uinput.KEY_LEFTCTRL, uinput.KEY_H),
    0x31 : (uinput.KEY_LEFTCTRL, uinput.KEY_J),
    0x77 : (uinput.KEY_LEFTCTRL, uinput.KEY_K),
    0x72 : (uinput.KEY_LEFTCTRL, uinput.KEY_L),
    0x62 : (uinput.KEY_LEFTCTRL, uinput.KEY_COMMA),
#row 4
    0x46 : (uinput.KEY_LEFTCTRL, uinput.KEY_Z),
    0x45 : (uinput.KEY_LEFTCTRL, uinput.KEY_X),
    0x44 : (uinput.KEY_LEFTCTRL, uinput.KEY_C),
    0x43 : (uinput.KEY_LEFTCTRL, uinput.KEY_V),
    0x42 : (uinput.KEY_LEFTCTRL, uinput.KEY_B),
    0x41 : (uinput.KEY_LEFTCTRL, uinput.KEY_N),
    0x52 : (uinput.KEY_LEFTCTRL, uinput.KEY_M),
    0x53 : (uinput.KEY_LEFTCTRL, uinput.KEY_DOT),
    0x63 : (uinput.KEY_LEFTCTRL, uinput.KEY_ENTER),
#row 5
    0x55 : (uinput.KEY_LEFTCTRL, uinput.KEY_LEFT),
    0x54 : (uinput.KEY_LEFTCTRL, uinput.KEY_SPACE),
    0x51 : (uinput.KEY_LEFTCTRL, uinput.KEY_RIGHT),
    0x71 : (uinput.KEY_LEFTCTRL, uinput.KEY_BACKSPACE)
}
